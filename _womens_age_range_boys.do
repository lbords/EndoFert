...
*----------------------------------------------------------------------*
* Fertility Preferences by Age - Boys
*----------------------------------------------------------------------*

	reghdfe w_ideal_boys_trunc recent_firstborn_daughter recent_firstborn ///
	...
	outreg2 using "raid/lfborden/Endogenous_Fertility/reg_output/womens_age_range_boys.tex", ///
